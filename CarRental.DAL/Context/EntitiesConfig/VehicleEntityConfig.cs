    ...
    private static void SeedVehicles(EntityTypeBuilder<VehicleEntity> builder)
    {
        builder.HasData(
            new VehicleEntity
            {
                ...
                Type = VehicleTypeDAL.Sedan,
                ReservationType = ReservationTypeDAL.Reserved,
                Price = 50.00,
            ...
            new VehicleEntity
            {
                ...
                Type = VehicleTypeDAL.Van,
                ReservationType = ReservationTypeDAL.Free,
                Price = 65.00,
